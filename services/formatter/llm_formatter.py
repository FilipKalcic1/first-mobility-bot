    ...
    async def format(
        ...
        *,
        ...
        system = (
            ...
            "4) Vrijednosti (brojevi, šifre, registracije, ID-evi, iznosi) prikaži "
            "TOČNO kako su u JSON-u — NE zaokružuj, NE aproksimiraj ('oko'/'otprilike'), "
            "NE mijenjaj ni grupiraj znamenke. Datum smiješ prikazati kao 'dd.mm.yyyy.'. "
